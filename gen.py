...
# If you use a custom banner from any site, you may use cbanner.py to add colors easily
...
def main():
    ...
    while True:
        if (num=="1"):
        	...
        	os.system("xdg-open --view https://github.com/Ephaberg?tab=repositories")
        else:
